...
!function(t, e) {
    ...
    var i, o, r = function(t) {
        ...
        Object.keys(n).forEach((function(i) {
            var o, r = n[i], s = e[i], a = s && u(s) ? "element" : null == (o = s) ? "" + o : {}.toString.call(o).match(/\s([a-z]+)/i)[1].toLowerCase();
    ...
    var M = {
        ...
        trigger: function(t, e, n) {
            if ("string" != typeof e || !t)
                return null;
            var i, o = v(), r = e.replace(L, ""), s = e !== r, a = D.indexOf(r) > -1, l = !0, c = !0, f = !1, u = null;
            return s && o && (i = o.Event(e, n),
            o(t).trigger(i),
            l = !i.isPropagationStopped(),
            c = !i.isImmediatePropagationStopped(),
            f = i.isDefaultPrevented()),
            a ? (u = document.createEvent("HTMLEvents")).initEvent(r, l, !0) : u = new CustomEvent(e,{
                bubbles: l,
                cancelable: !0
            }),
      ...
      , R = function() {
        function t(t) {
            this._element = t,
            this._element && y(t, "bs.alert", this)
        }
        var n = t.prototype;
    ...
    var U = {
      ...
      , X = function() {
        ...
        i._slide = function(t, e) {
            var n, i, o, r = this, s = Q.findOne(".active.carousel-item", this._element), a = this._getItemIndex(s), l = e || s && this._getItemByDirection(t, s), f = this._getItemIndex(l), u = Boolean(this._interval);
    ...
    M.on(document, "click.bs.carousel.data-api", "[data-slide], [data-slide-to]", X.dataApiClickHandler),
    ...
    var G = "collapse"
      ...
      , J = function() {
        function t(t, e) {
            ...
            this._element = t,
            this._config = this._getConfig(e),
            this._triggerArray = Q.find('[data-toggle="collapse"][href="#' + t.id + '"],[data-toggle="collapse"][data-target="#' + t.id + '"]');
            for (var n = Q.find('[data-toggle="collapse"]'), i = 0, o = n.length; i < o; i++) {
                ...
                null !== s && l.length && (this._selector = s,
        ...
        i.show = function() {
            ...
            if (!this._isTransitioning && !this._element.classList.contains("show")) {
                ...
                if (n) {
                    ...
                    if ((i = r[0] ? w(r[0], "bs.collapse") : null) && i._isTransitioning)
                        return
                }
        ...
        ,
        i._getConfig = function(t) {
            return (t = n({}, $, t)).toggle = Boolean(t.toggle),
            d(G, t, Z),
            t
        }
        ,
    ...
    var tt = "undefined" != typeof window && "undefined" != typeof document && "undefined" != typeof navigator
      , et = function() {
        for (var t = ["Edge", "Trident", "Firefox"], e = 0; e < t.length; e += 1)
            if (tt && navigator.userAgent.indexOf(t[e]) >= 0)
                return 1;
        return 0
    }();
    ...
    function dt(t, e) {
        ...
        if (t !== l && e !== l || i.contains(o))
            return "BODY" === (a = (s = l).nodeName) || "HTML" !== a && ut(s.firstElementChild) !== s ? ut(l) : l;
        var c = ht(t);
    ...
    function kt(t, e) {
        ...
        return (i && !n ? e.contains(a) : e === a && "BODY" !== a.nodeName) && (u = gt(u, e)),
        u
    }
    function Ct(t) {
    ...
    function Ot(t) {
        ...
        if ("BODY" === e || "HTML" === e)
            return !1;
        if ("fixed" === ot(t, "position"))
            return !0;
        var n = rt(t);
        return !!n && Ot(n)
    }
    function At(t) {
        if (!t || !t.parentElement || ft())
            return document.documentElement;
    ...
    function Ht(t, e, n) {
        return (void 0 === n ? t : t.slice(0, function(t, e, n) {
            ...
            t.enabled && it(n) && (e.offsets.popper = Tt(e.offsets.popper),
    ...
    function Rt() {
        if (!this.state.isDestroyed) {
            ...
            t.placement = xt(this.options.placement, t.offsets.reference, this.popper, this.reference, this.options.modifiers.flip.boundariesElement, this.options.modifiers.flip.padding),
    ...
    function Wt() {
        ...
        Bt(this.modifiers, "applyStyle") && (this.popper.removeAttribute("x-placement"),
        ...
        modifiers: {
            ...
            arrow: {
                ...
                fn: function(t, e) {
                    ...
                    t.arrowElement = i,
                    t.offsets.arrow = (wt(n = {}, u, Math.round(b)),
                    wt(n, h, ""),
                    n),
                    t
                },
            ...
            flip: {
                ...
                enabled: !0,
                fn: function(t, e) {
                    if (Bt(t.instance.modifiers, "inner"))
                        return t;
                    ...
                    return s.forEach((function(a, l) {
                        ...
                        t.placement = i + (r ? "-" + r : ""),
                        t.offsets.popper = Et({}, t.offsets.popper, Pt(t.instance.popper, t.offsets.reference, t.placement)),
            ...
            computeStyle: {
                ...
                fn: function(t, e) {
                    ...
                    var s = void 0 !== r ? r : e.gpuAcceleration
                      ...
                      , p = void 0
                      , g = void 0;
                    if (g = "bottom" === u ? "HTML" === a.nodeName ? -a.clientHeight + f.bottom : -l.height + f.bottom : f.top,
                    p = "right" === h ? "HTML" === a.nodeName ? -a.clientWidth + f.right : -l.width + f.right : f.left,
                    s && d)
                    ...
                    return t.attributes = Et({}, _, t.attributes),
            ...
            applyStyle: {
                ...
                fn: function(t) {
                    var e, n;
                    return zt(t.instance.popper, t.styles),
                    e = t.instance.popper,
                    n = t.attributes,
                    ...
                    t.arrowElement && Object.keys(t.arrowStyles).length && zt(t.arrowElement, t.arrowStyles),
                    t
                },
      ...
      , ce = function() {
            ...
            if (!(this._element.disabled || this._element.classList.contains("disabled") || this._menu.classList.contains("show"))) {
                ...
                if (!M.trigger(this._element, "show.bs.dropdown", n).defaultPrevented) {
                    if (!this._inNavbar) {
                        ...
                        var i = this._element;
                        "parent" === this._config.reference ? i = e : u(this._config.reference) && (i = this._config.reference,
        ...
        i.hide = function() {
            if (!this._element.disabled && !this._element.classList.contains("disabled") && this._menu.classList.contains("show")) {
                ...
                M.trigger(e, "hide.bs.dropdown", n).defaultPrevented || (this._popper && this._popper.destroy(),
                this._menu.classList.toggle("show"),
                this._element.classList.toggle("show"),
        ...
        ,
        i._getConfig = function(t) {
            return t = n({}, this.constructor.Default, U.getDataAttributes(this._element), t),
        ...
        i._getPlacement = function() {
            var t = this._element.parentNode
              , e = "bottom-start";
            return t.classList.contains("dropup") ? e = this._menu.classList.contains("dropdown-menu-right") ? "top-end" : "top-start" : t.classList.contains("dropright") ? e = "right-start" : t.classList.contains("dropleft") ? e = "left-start" : this._menu.classList.contains("dropdown-menu-right") && (e = "bottom-end"),
            e
        }
        ,
        ...
        t.dataApiKeydownHandler = function(e) {
            if (!(/input|textarea/i.test(e.target.tagName) ? "Space" === e.key || "Escape" !== e.key && ("ArrowDown" !== e.key && "ArrowUp" !== e.key || e.target.closest(".dropdown-menu")) : !se.test(e.key)) && (e.preventDefault(),
            e.stopPropagation(),
            !this.disabled && !this.classList.contains("disabled"))) {
                var n = t.getParentFromElement(this)
                  , i = this.classList.contains("show");
                if ("Escape" === e.key)
                    return (this.matches('[data-toggle="dropdown"]') ? this : Q.prev(this, '[data-toggle="dropdown"]')[0]).focus(),
                    void t.clearMenus();
                if (i && "Space" !== e.key) {
    ...
    M.on(document, "keydown.bs.dropdown.data-api", '[data-toggle="dropdown"]', ce.dataApiKeydownHandler),
    ...
    var fe = {
      ...
      , he = function() {
        ...
        i.hide = function(t) {
            ...
            this._isShown && !this._isTransitioning) && !M.trigger(this._element, "hide.bs.modal").defaultPrevented) {
                this._isShown = !1;
        ...
        i._showElement = function(t) {
            ...
            var o = function() {
                ...
                M.trigger(e._element, "shown.bs.modal", {
                    relatedTarget: t
                })
            };
            if (n) {
                var r = c(this._dialog);
                M.one(this._dialog, "transitionend", o),
                h(this._dialog, r)
            } else
                o()
        }
        ...
        i._showBackdrop = function(t) {
            ...
            if (this._isShown && this._config.backdrop) {
                ...
                M.one(this._backdrop, "transitionend", t),
                h(this._backdrop, i)
                ...
                if (this._element.classList.contains("fade")) {
                    ...
                    M.one(this._backdrop, "transitionend", o),
                    h(this._backdrop, r)
                } else
                    o()
            } else
        ...
        i._triggerBackdropTransition = function() {
            ...
            if ("static" === this._config.backdrop) {
                ...
                M.one(this._element, "transitionend", (function() {
                    ...
                    e || (M.one(t._element, "transitionend", (function() {
        ...
        i._resetScrollbar = function() {
            Q.find(".fixed-top, .fixed-bottom, .is-fixed, .sticky-top").forEach((function(t) {
                ...
                void 0 !== e && (U.removeDataAttribute(t, "padding-right"),
                t.style.paddingRight = e)
            }
            )),
            Q.find(".sticky-top").forEach((function(t) {
                var e = U.getDataAttribute(t, "margin-right");
                void 0 !== e && (U.removeDataAttribute(t, "margin-right"),
                t.style.marginRight = e)
            }
            ));
            var t = U.getDataAttribute(document.body, "padding-right");
            void 0 === t ? document.body.style.paddingRight = "" : (U.removeDataAttribute(document.body, "padding-right"),
        ...
        for (var o = (new window.DOMParser).parseFromString(t, "text/html"), r = Object.keys(e), s = (i = []).concat.apply(i, o.body.querySelectorAll("*")), a = function(t, n) {
            ...
            l.forEach((function(t) {
                (function(t, e) {
                    ...
                    if (-1 !== e.indexOf(n))
                        return -1 === de.indexOf(n) || Boolean(t.nodeValue.match(pe) || t.nodeValue.match(ge));
      ...
      , ke = function() {
        ...
        i.show = function() {
            ...
            if (this.isWithContent() && this._isEnabled) {
                ...
                if (y(o, this.constructor.DATA_KEY, this),
                ...
                if (this.tip.classList.contains("fade")) {
                    var p = c(this.tip);
                    M.one(this.tip, "transitionend", d),
                    h(this.tip, p)
                } else
                    d()
            }
        ...
        i.setElementContent = function(t, e) {
            if (null !== t)
                return "object" == typeof e && u(e) ? (e.jquery && (e = e[0]),
                void (this.config.html ? e.parentNode !== t && (t.innerHTML = "",
                t.appendChild(e)) : t.textContent = e.textContent)) : void (this.config.html ? (this.config.sanitize && (e = ve(e, this.config.allowList, this.config.sanitizeFn)),
        ...
        i._enter = function(t, e) {
            ...
            (e = e || w(t.delegateTarget, n)) || (e = new this.constructor(t.delegateTarget,this._getDelegateConfig()),
    ...
    var Me = function() {
        function t(t) {
            this._element = t,
            y(this._element, "bs.tab", this)
        }
        var n = t.prototype;
        return n.show = function() {
            var t = this;
            if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && this._element.classList.contains("active") || this._element.classList.contains("disabled"))) {
                var e, n = l(this._element), i = this._element.closest(".nav, .list-group");
                if (i) {
    ...
    M.on(document, "click.bs.tab.data-api", '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', (function(t) {
        t.preventDefault(),
        (w(this, "bs.tab") || new Me(this)).show()
    }
    )),
    _((function() {
        var t = v();
    ...
    var He = {
      ...
      , Be = function() {
        ...
        return i.show = function() {
            ...
            if (!M.trigger(this._element, "show.bs.toast").defaultPrevented) {
                ...
                this._config.animation) {
                    ...
                    M.one(this._element, "transitionend", e),
                    h(this._element, n)
                } else
                    e()
            }
        ...
        ,
        i._getConfig = function(t) {
            return t = n({}, Re, U.getDataAttributes(this._element), "object" == typeof t && t ? t : {}),
